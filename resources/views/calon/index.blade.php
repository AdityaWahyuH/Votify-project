...
<nav class="navbar navbar-expand-lg navbar-dark mb-5 sticky-top shadow-sm">
    <div class="container">
        ...
        <div class="navbar-nav ms-auto">
            ...
            <a class="nav-link active" href="{{ route('calon.public') }}">Kandidat</a>
...
<div class="container mb-5">
    ...
    <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-calon">
                    ...
                    <div class="img-wrapper">
                        @if($calon->foto)
                            {{-- FIX: file ada di public/images, DB hanya nama file --}}
                            <img src="{{ asset('images/'.$calon->foto) }}" class="img-calon" alt="{{ $calon->nama }}">
                        @else
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-secondary text-center py-4">Belum ada data calon DPM.</div>
            </div>
        @endforelse
    </div>
    ...
    <div class="row g-4">
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-secondary text-center py-4">Belum ada data calon BEM.</div>
            </div>
        @endforelse
    </div>
</div>
